...
export default function ConnexionTool(){
    ...
    const setArticleFromSearch = (code: string) =>{
        ...
        setMainArticleCode(code);
        fetchConnexions(code);
    }
    ...
    return(
        ...
        <>
            ...
            <div className="flex-1 overflow-hidden flex flex-col h-full p-3 box-border">
                        ...
                        {/* Main input search */}
                        <div className="flex self-center items-center gap-2 bg-blue-light p-3 rounded-[20px]">
                            ...
                            {/* Search by str */}
                            <svg onClick={()=>setShowStrSearching(true)} className="fill-blue-primary/90 cursor-pointer hover:fill-blue-primary hover:scale-105 transition" xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24"><path d="M15.25 2h-6.5A6.76 6.76 0 0 0 2 8.75v6.5A6.76 6.76 0 0 0 8.75 22h6.5A6.76 6.76 0 0 0 22 15.25v-6.5A6.76 6.76 0 0 0 15.25 2m2 14.94a.78.78 0 0 1-.57.23a.8.8 0 0 1-.56-.23l-2-2a4.81 4.81 0 1 1 1.13-1.13l2 2a.79.79 0 0 1 .01 1.13z"/><path d="M14.5 11a3.21 3.21 0 1 1-6.418 0a3.21 3.21 0 0 1 6.418 0"/></svg>
                                            ...
                                            {/* Compatible products */}
                                            {
                                                selectedConnexionIndex !== null  && 
                                                    ...
                                                    transition={{type: "spring",stiffness: 600,damping: 20}}>
                                                        ...
                                                        {/* Research bar */}
                                                        <div className="flex self-start items-center gap-2 bg-white p-1 px-3 rounded-[10px]">
